            ...
            */
            ...
            if (mach) {
              msg.$sendjsonreply({
                success:    false,
                mid:        mid,
                desc:       'The machine is already loaded into the zone.',
              });
              break;
            }

            var mach = state.zhosts[zid].createMachineInstanceWithMID(mid, function (mach) {
              if (!mach) {
                msg.$sendjsonreply({
                  success:    false,
                  mid:        mid,
                  desc:       'Failed to create an instance of the machine.',
                });
              }
            });
            break;
